          ...
          <div className="flex flex-wrap gap-2">
            <button
              ...
              style={{
                ...
                "--tw-ring-color": !selectedCategory ? "var(--blue-500)" : "transparent",
            ...
            {categories.map((category) => (
              <button
                ...
                style={{
                  ...
                  color: "var(--text)",
                  border: "1px solid var(--border)",
                  "--tw-ring-color": selectedCategory === category ? "var(--blue-500)" : "transparent",
                } as React.CSSProperties}
              >
                {category}
              </button>
            ...
            {tags.map((tag) => (
              <button
                ...
                style={{
                  ...
                  border: "1px solid var(--border)",
                  "--tw-ring-color": selectedTags.includes(tag) ? "var(--blue-300)" : "transparent",
                } as React.CSSProperties}
              >
                {tag}
              </button>
