...
const EXTENDED_KPI_DATA = [
  ...
  /* ================== TELECOMMUNICATIONS (15) - NEW SIGNAVIO PROCESS KPIs ================== */
  {
    kpiName: "RRC Connection Success Rate",
    businessFunction: "Operations",
    e2eProcess: "Network Access",
    measurementUnit: "%",
  ...
  {
    kpiName: "PDU Session Establishment Success Rate",
    businessFunction: "Operations",
    e2eProcess: "Data Session Management",
    measurementUnit: "%",
  ...
  {
    kpiName: "Handover Success Rate (Inter/Intra-Frequency)",
    businessFunction: "Operations",
    e2eProcess: "Mobility Management",
    measurementUnit: "%",
  ...
  {
    kpiName: "Average Call Setup Time (VoLTE/5G Voice)",
    businessFunction: "Operations",
    e2eProcess: "Voice Session Setup",
  ...
  {
    kpiName: "Video Start Time (Initial Buffering)",
    businessFunction: "Operations",
    e2eProcess: "Customer Experience (Streaming)",
    measurementUnit: "Seconds",
    industryAverage: "2.0",
    bestInClass: "≤1.0",
    targetRange: "Low",
  ...
  {
    kpiName: "Proactive Fault Detection Rate",
    businessFunction: "Operations",
    e2eProcess: "Assurance (Fault Management)",
    measurementUnit: "%",
    industryAverage: "60%",
    bestInClass: "≥80%",
    targetRange: "High",
  ...
  {
    kpiName: "Service Order Fallout Rate",
    businessFunction: "Operations/IT",
    e2eProcess: "Fulfillment (Lead-to-Activate)",
    measurementUnit: "%",
    industryAverage: "3.0%",
    bestInClass: "≤1.0%",
    targetRange: "Low",
  ...
  {
    kpiName: "First Visit Resolution Rate (Onsite)",
    businessFunction: "Operations",
    e2eProcess: "Field Service",
    measurementUnit: "%",
    industryAverage: "88%",
    bestInClass: "≥95%",
    targetRange: "High",
  ...
  {
    kpiName: "CDR Mediation Completeness",
    businessFunction: "Finance/IT",
    e2eProcess: "Billing Event Collection",
    measurementUnit: "%",
    industryAverage: "99.95%",
    bestInClass: "≥99.99%",
    targetRange: "High",
    industry: "Telecommunications",
    icon: BarChart3,
  ...
  {
    kpiName: "Rating Accuracy Rate (BRIM)",
    businessFunction: "Finance",
    e2eProcess: "Charging & Billing",
    measurementUnit: "%",
    industryAverage: "99.9%",
    bestInClass: "≥99.95%",
    targetRange: "High",
    industry: "Telecommunications",
    icon: BarChart3,
  ...
  {
    kpiName: "Dunning Recovery Rate (30-Day)",
    businessFunction: "Finance",
    e2eProcess: "Collections",
    measurementUnit: "%",
    industryAverage: "45%",
    bestInClass: "≥60%",
    targetRange: "High",
  ...
  {
    kpiName: "Roaming Attach Success Rate",
    businessFunction: "Operations",
    e2eProcess: "Roaming Enablement",
    measurementUnit: "%",
    industryAverage: "98.0%",
    bestInClass: "≥99.0%",
    targetRange: "High",
  ...
  {
    kpiName: "Partner Settlement Dispute Rate (Interconnect/Roaming)",
    businessFunction: "Finance",
    e2eProcess: "Partner Settlement",
    measurementUnit: "%",
    industryAverage: "0.5%",
    bestInClass: "≤0.1%",
    targetRange: "Low",
  ...
  {
    kpiName: "SIM Swap Completion Time",
    businessFunction: "Customer Service",
    e2eProcess: "Care & Provisioning",
  ...
  {
    kpiName: "5G Slice SLA Compliance",
    businessFunction: "Operations",
    e2eProcess: "Enterprise Service Management",
    measurementUnit: "%",
    industryAverage: "99.0%",
    bestInClass: "≥99.5%",
    targetRange: "High",
    industry: "Telecommunications",
    icon: BarChart3,
