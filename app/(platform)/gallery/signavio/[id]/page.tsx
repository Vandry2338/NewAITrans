...
export default function SignavioDetailPage({ params }: { params: Promise<{ id: string }> }) {
  ...
  return <DetailedView content={content as any} onBack={handleBack} onAddToDesign={handleAddToDesign as any} onShare={handleShare as any} />
}
