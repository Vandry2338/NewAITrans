      ...
      <div className="max-w-6xl mx-auto px-6 py-8">
        ...
        <div className="mt-12">
          <h2 className="text-2xl font-bold mb-8 text-center" style={{ color: "var(--text)", fontFamily: "var(--font-sap-72)" }}>
            See Event-Driven Applications in Action
          </h2>
              ...
              <div className="bg-gradient-to-br from-indigo-600 to-purple-800 p-6">
                <div className="flex items-center gap-4 mb-4">
                  ...
                  <div>
                    ...
                    <p className="text-indigo-100" style={{ fontFamily: "var(--font-sap-72)" }}>
                ...
                <div className="mt-4 flex items-center justify-between text-sm text-indigo-100">
                  <span style={{ fontFamily: "var(--font-sap-72)" }}>Duration: 3:00</span>
            ...
            <div className="group relative overflow-hidden rounded-2xl shadow-lg hover:shadow-2xl transition-all duration-300">
              <div className="bg-gradient-to-br from-purple-600 to-indigo-700 p-6">
                <div className="flex items-center gap-4 mb-4">
                  ...
                  <div>
                    ...
                    <p className="text-purple-100" style={{ fontFamily: "var(--font-sap-72)" }}>
                      Scalable event streaming and routing
                    </p>
                  </div>
                </div>
                ...
                <div className="mt-4 flex items-center justify-between text-sm text-purple-100">
                  <span style={{ fontFamily: "var(--font-sap-72)" }}>Duration: 2:15</span>
                  <div className="flex items-center gap-2">
                    <div className="w-2 h-2 bg-green-400 rounded-full"></div>
