      ...
      <div className="max-w-6xl mx-auto px-6 py-8">
        ...
        <div className="mt-12">
          <h2 className="text-2xl font-bold mb-8 text-center" style={{ color: "var(--text)", fontFamily: "var(--font-sap-72)" }}>
            See SAP Build Process Automation in Action
          </h2>
          
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
            {/* Demo Video Card */}
            <div className="group relative overflow-hidden rounded-2xl shadow-lg hover:shadow-2xl transition-all duration-300">
              <div className="bg-gradient-to-br from-green-600 to-teal-800 p-6">
                <div className="flex items-center gap-4 mb-4">
                  ...
                  <div>
                    ...
                    <p className="text-green-100" style={{ fontFamily: "var(--font-sap-72)" }}>
                ...
                <div className="mt-4 flex items-center justify-between text-sm text-green-100">
                  <span style={{ fontFamily: "var(--font-sap-72)" }}>Duration: 4:15</span>
            ...
            <div className="group relative overflow-hidden rounded-2xl shadow-lg hover:shadow-2xl transition-all duration-300">
              <div className="bg-gradient-to-br from-teal-600 to-green-700 p-6">
                <div className="flex items-center gap-4 mb-4">
                  <div className="w-12 h-12 rounded-lg bg-white/20 flex items-center justify-center">
                    <PlayIcon className="w-6 h-6 text-white" />
                  </div>
                  <div>
                    ...
                    <p className="text-teal-100" style={{ fontFamily: "var(--font-sap-72)" }}>
                ...
                <div className="mt-4 flex items-center justify-between text-sm text-teal-100">
