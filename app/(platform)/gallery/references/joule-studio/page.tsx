...
const pageData = {
  ...
  "subtitle": "Extend Joule with custom Skills & AI Agents",
  "tags": ["Generative AI", "Agents", "SAP Build", "Application Development & Automation"],
  "updated": {
    "date": "Jun 25, 2025",
    "by": "fabianleh"
  },
...
export default function JouleStudioPage() {
  ...
  const handleOpenInDrawIO = () => {
    ...
    window.open(`https://embed.diagrams.net/?embed=1&spin=1&modified=unsavedChanges&proto=json#R${encodeURIComponent('/diagrams/joule-studio.drawio')}`, '_blank')
  }
