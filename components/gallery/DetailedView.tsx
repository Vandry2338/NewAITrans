...
interface DetailedContent extends GalleryItem {
  overview?: string
  features?: string[]
  requirements?: string[]
  useCases?: string[]
          ...
          <section className="mb-12">
            ...
            >
              <div className="relative aspect-video">
                ...
                <img
                  src={content.demo?.videoUrl || "/placeholder.svg?height=400&width=800&query=demo video"}
                ...
                {content.estTimelineWeeks && (
                  <div className="absolute bottom-4 right-4">
                    ...
                    >
                      {content.estTimelineWeeks}w est.
                    </span>
                  </div>
                )}
              </div>
                ...
                {content.benefits.map((benefit, index) => (
                  ...
                  >
                    ...
                    <span className="text-sm" style={{ color: "var(--green-800)" }}>
                      {typeof benefit === 'string' ? benefit : `${benefit.metric}: ${benefit.value}${benefit.unit ? ' ' + benefit.unit : ''}`}
                    </span>
                  </div>
                ))}
              </div>
