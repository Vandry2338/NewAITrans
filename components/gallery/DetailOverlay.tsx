...
interface DetailOverlayProps {
  ...
  isOpen: boolean
  onClose: () => void
  onOpenFullPage?: (content: GalleryItem) => void
}
          ...
          <div className="space-y-6">
            <div>
              ...
              <p className="text-sm leading-relaxed" style={{ color: "var(--text-muted)" }}>
                {content.summary}. This solution provides comprehensive functionality for modern business processes,
        ...
        return (
          <div className="space-y-4">
            <div className="relative rounded-xl overflow-hidden bg-black" style={{ aspectRatio: "16/9" }}>
              {content.demo?.videoUrl ? (
                <video className="w-full h-full object-cover" controls poster={content.demo.videoUrl} preload="metadata">
                  <source src={content.demo.videoUrl} type="video/mp4" />
